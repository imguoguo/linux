 ...
 * Copyright (c) 2025 Guodong Xu <docular.xu@gmail.com>
 */

#ifndef _DT_BINDINGS_DMA_SPACEMIT_K3_PDMA_H_
#define _DT_BINDINGS_DMA_SPACEMIT_K3_PDMA_H_
...
#endif /* _DT_BINDINGS_DMA_SPACEMIT_K3_PDMA_H_ */
