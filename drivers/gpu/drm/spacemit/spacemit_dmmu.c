...
static inline void spacemit_dmmu_fill_pgtable(u32 *ttbr, struct sg_table *sgt)
{
	...
	/* The silicon over-fetches past the last entry; pad it to avoid a DDR fault. */
	temp = *(ttbr - 1);
		 ...
		 struct drm_plane *plane)
{
	...
	spacemit_dmmu_fill_pgtable((u32 *)(mmu_tbl->va), sgt);
