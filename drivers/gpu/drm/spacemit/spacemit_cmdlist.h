 ...
 * @CMDLIST_PLANE: Per-plane RDMA and scaler register batches.
 ...
 * @mode_mask: Contributing cmdlist_mode_type sources; gates which rows are pulled.
 ...
 * @index: Slot index in the per-pipeline cmdlist group pool.
